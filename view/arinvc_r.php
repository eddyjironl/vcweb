<html>
	...
	<body>
		<form target="_blank" method="POST" action="../reports/rpt_arinvc.php" id="arinvc_r" name="arinvc_r" class= "form2">
			<script> get_barraprint("Resumen de Ventas","Ayuda resumen de ventas.");</script>
