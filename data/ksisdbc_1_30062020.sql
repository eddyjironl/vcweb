...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 01-07-2020 a las 04:03:58
...
INSERT INTO `arserm` (`cservno`, `cdesc`, `ncost`, `nprice`, `ctserno`, `cstatus`, `cmedno`, `crespno`, `cctaid`, `cctaid_c`, `cctaid_i`, `citemtype`, `mnotas`, `cfoto`, `lupdonhand`, `lallowneg`, `nlastcost`, `nprice1`, `nprice2`, `ntax`, `ndesc`, `lupdateonhand`) VALUES
('01', 'Leche Sula', '13.00', '15.00', '', '', '', '', '', '', '', '', '', '', 0, 0, '0.00', '0.00', '0.00', '10.00', '5.00', 0),
('02', 'Maseca', '8.33', '10.00', '', '', '', '', '', '', '', '', '', '', 0, 0, '0.00', '0.00', '0.00', '10.00', '5.00', 0);
...
--
ALTER TABLE `arinvt_tmp`
  MODIFY `cuid` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=665;
