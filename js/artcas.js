...
function init(){
	...
	// CADA MENU
	//document.getElementById("btcpaycode").addEventListener("click",getmenulist,false);
	document.getElementById("btcpaycode").addEventListener("click",show_menu_artcas,false);
...
function select_xkey(e){
	...
	document.getElementById("cpaycode").value = lckey;
	cerrar_mx_view();
	update_window(lckey);
